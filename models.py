...
# Unable to inspect table 'math'
# The error was: 'NoneType' object is not subscriptable


class MathappCalculate(models.Model):
    id = models.TextField(primary_key=True)  # This field type is a guess.
    number1 = models.TextField()  # This field type is a guess.
    number2 = models.TextField()  # This field type is a guess.

    class Meta:
        managed = False
        db_table = 'mathApp_calculate'
